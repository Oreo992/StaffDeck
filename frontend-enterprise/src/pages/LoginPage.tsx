 ...
 * a full-bleed hero with the Agent Team wordmark and a product-preview placeholder
    ...
    <div className="relative flex min-h-screen flex-col bg-white">
      ...
      <main className="flex flex-1 flex-col items-center px-[32px]">
        ...
        <div className="mt-[32px] flex w-full justify-center">
          <div className="relative w-full max-w-[1200px] overflow-hidden rounded-[24px]">
            <img
              src={loginPreview}
              alt="Agent Team 产品预览"
              ...
              draggable={false}
            />
            <div className="absolute left-[2.5%] top-[2.5%] flex h-[8%] w-[14%] items-center bg-[#fbfcfe] px-[0.6%]">
              <BrandLogo className="origin-left scale-[0.78]" markSize={28} />
            </div>
          </div>
        </div>
      </main>
