    ...
    <main className="tutorial-doc-page">
      <section className="tutorial-doc-hero" id="intro">
        <div className="tutorial-doc-hero-copy">
          <span className="ui-typography tutorial-doc-eyebrow">Agent Team Docs</span>
          <h1 className="ui-typography">企业数字员工运行时，从配置到持续运营</h1>
          <p className="ui-typography">
            Agent Team 把模型、数字员工、知识库、技能、SOP、工具、记忆、定时任务和 Trace 放到一条链路里，
        ...
        <div className="tutorial-doc-hero-map" aria-label="Agent Team runtime map">
      ...
      <div className="tutorial-doc-shell">
        <aside className="tutorial-doc-nav" aria-label="Agent Team 单页文档目录">
      ...
      <section className="tutorial-doc-section tutorial-doc-intro-panel">
        <div>
          ...
          <p className="ui-typography">
            Agent Team 的核心不是“能聊天”，而是让一个真实岗位拥有自己的配置、资源、执行规则和运营记录。
      ...
      <section className="tutorial-doc-section" id="core-features">
        <SectionHeading
          ...
          body="PilotDeck 把能力分成 WorkSpace、Router、Memory、Always On、Gateway；Agent Team 对应到企业数字员工场景，重点是岗位边界、知识治理、流程执行、工具调用和运营复盘。"
        />
      ...
      <section className="tutorial-doc-section tutorial-doc-runtime" id="runtime">
        <SectionHeading
          ...
          title="一条业务请求如何被推进"
          body="Agent Team 的对话不是单轮问答。它会在路由、知识、技能、SOP、工具和回复生成之间形成可追踪执行链路。"
        />
